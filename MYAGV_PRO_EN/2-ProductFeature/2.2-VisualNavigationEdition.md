...
| INPUT IO          | 6-channel Digital Input | Receives external signals (such as safety light curtain trigger signals),Provided [API interface](../6-SDKDevelopment/6.1-ApplicationBasePython/6.1.2-API.md#get_pin_inputpin) development. |
| OUTPUT            | 6-channel Digital Output | Controls external devices (such as indicator lights, buzzers, relays),Provided [API interface](../6-SDKDevelopment/6.1-ApplicationBasePython/6.1.2-API.md#set_pin_outputpin-state) development. |
...
![](../resources/2-ProductFeature/2.2/6.png)
...
![](../resources/2-ProductFeature/2.2/5.png)
...
| Range (@ 100 klx)            | 40 m @ 10% reflectivity <br/>70 m @ 80% reflectivity |
| Near Blind Spot              | 0.1 m                                                |
| Field of View                | Horizontal 360°, Vertical -7° to 52°                 |
| Ranging Error (1σ)           | ≤ 2 cm (@ 10m) <br/>≤ 3 cm (@ 0.2m)                  |
