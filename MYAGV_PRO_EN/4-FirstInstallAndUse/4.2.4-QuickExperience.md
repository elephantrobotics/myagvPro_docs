...
|-----------|---------------------|--------------|------------------------------------------------------------|
| `L1`      | Rotate the cat left | `L2`         | Increase speed                                             |
| `R1`      | Rotate the car Right | `R2`         | Decrease speed                                      |
| `SELECT + Joystick 2` | Control the car to move forward, backward, left, and right |
...
![Software Interface](../resources/4-FirstInstallAndUse/4.2/KeyboardControl%201.png)
