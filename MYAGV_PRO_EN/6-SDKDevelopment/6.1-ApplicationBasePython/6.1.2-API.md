...
### 6.3.1 Obtaining the AGVPro Wi-Fi Account and Password in Serial Communication Mode
```python
from pymycobot import MyAGVPro
...
```
### 6.3.2 Set the current communication mode to Socket mode
```python
