...
Source the local setup script of your ROS 2 workspace.
...
[← Previous Chapter](../6.1-ApplicationBasePython/README.md) | [Next Page →](6.2.2-Real-time_Mapping_with_Gmapping.md)
